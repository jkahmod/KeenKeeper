...
const Footer = () => {
    return (
        <div className='bg-[#244D3F] h-70 mt-10 p-10  '>
            <div className='w-[100%] lg-[1400px]'>
                <div className='text-white text-center'>
                    <img className='m-auto' src={Flogo} alt="" />
                    <p>Your personal shelf of meaningful connections. Browse, tend, and nurture the relationships that matter most.</p>
                    <p className='text-xl font-bold mt-5 mb-3'>Social Links</p>
                ...
                <div className='text-white flex justify-between w-[100%] lg:w-[1400px] m-auto'>
                    <p>
